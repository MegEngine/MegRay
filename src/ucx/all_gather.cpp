...
Status UcxCommunicator::all_gather(const void* sendbuff, void* recvbuff,
    ...
    // i-th part of msg passes from i-th node to i+1 to i+2 and finally to
    // (i-1)-th node after nranks - 1 rounds every node has all msg
