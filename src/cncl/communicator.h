 ...
 */
class CnclCommunicator : public Communicator {
public:
    CnclCommunicator(int nranks, int rank);
...
private:
    std::unique_ptr<CnclCommunicatorPrivate> m_cncl;
};
